<template>
	<div>
		...
		<div class="CaseList" v-if="caseDefinitions.length">
			<div class="card CaseList__item" :class="selectedCaseType && selectedCaseType.id === item.id ? 'active' : 'disabled'" v-for='item in caseDefinitions' :key="item.id">
		...
		<div class="patientType" v-if="selectedCaseType && selectedCaseType.children.length">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6"  v-for='item in selectedCaseType.children' :key="item.id">
					<div class="contentBox" :class="selectedPatientType && selectedPatientType.id == item.id ? 'active' : 'disabled'">
						<div class="image">
...
export default {
	...
	created() {
        if(this.service && this.service.service_data) {
		    this.caseDefinitions = this.service.order_line_obj.product_obj.case_definitions[0].case_definition.children
